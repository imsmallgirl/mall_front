        ...
        <FooterWrap>
            <Container>
                <FooterMenuUl>
                    ...
                    <FooterMenuLi><strong>개인정보취급방침</strong></FooterMenuLi>
                ...
                <FooterContentWrap>
                    <FooterContent width="25%">
                        ...
                        <dl className="footer-content1">
                            <dt>070-7732-7799</dt>
                            <dd><strong>평일</strong>오전 10:00 ~ 오후 15:00</dd>
                            <dd><strong>휴무</strong>토 / 일 / 공휴일은 휴무</dd>
                        </dl>
                    </FooterContent>
                    <FooterContent width="25%">
                        ...
                        <dl className="footer-content1">
                            <dt></dt>
                            <dd><strong>코린은행</strong>1234567-89-101112</dd>
                            <dd><strong>예금주</strong>코린이(코린이방)</dd>
                        </dl>
                ...
                <FooterBottomWrap>
                    <FooterBottomContent>
                        ...
                        <FooterBottomContentUl>
                            <FooterBottomContentLi><span>회사명</span>개발자쇼핑몰</FooterBottomContentLi>
                            <FooterBottomContentLi><span>대표</span>개발자</FooterBottomContentLi>
                            <FooterBottomContentLi><span>대표전화</span>123-4567-8910</FooterBottomContentLi>
                            <FooterBottomContentLi><span>팩스</span>12-345-6789</FooterBottomContentLi>
                        </FooterBottomContentUl>
                        <FooterBottomContentUl>
                            <FooterBottomContentLi><span>주소</span>코린특별시 코린구 코린2길 15</FooterBottomContentLi>
                        </FooterBottomContentUl>
                        <FooterBottomContentUl>
                            <FooterBottomContentLi><span>사업자 등록번호</span>123-45-67891</FooterBottomContentLi>
                            <FooterBottomContentLi><span>통신판매업 신고</span>제 2022-코린이구-1234 호</FooterBottomContentLi>
                        </FooterBottomContentUl>
                        <FooterBottomContentUl>
                            <FooterBottomContentLi><span>개인정보관리책임자</span>개발자(coding@naver.com)</FooterBottomContentLi>
                            <FooterBottomContentLi><span>이메일</span>coding@naver.com</FooterBottomContentLi>
                        </FooterBottomContentUl>
                    </FooterBottomContent>
                    <FooterBottomContent className="footer-right">
                        <p><span>KG 에스크로 이니페이</span> 를 통해 고객님은 안전한 거래를 위해 현금 등으로<br/>결제시 저희 쇼핑몰 에서 가입한 구매안전 서비스를 이용하실 수 있습니다.</p>
